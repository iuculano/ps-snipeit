<#
    .SYNOPSIS
    Updates one or more Snipe-IT companies.

    .PARAMETER InputObject
    Specifies an axSnipeIT.Company object returned by a previous 
    Get-SnipeITCompany call. This will be mapped to the user's Id.

    .PARAMETER Id
    Specifies the id of the company to update.
...
function Set-SnipeITCompany
{
    ...
    Process
    {
        ...
        foreach ($i in $identity)
        {
            ...
            $endpoint = "$Url/api/v1/companies/$i"   
